...
screen quick_menu():
    ...
    if quick_menu:
        ##Aqui estuvo el juan
        ##en este apartado esta el menu de la parte de abajo del sistema
        hbox:
            style_prefix "quick"
            ...
            textbutton _("A.Guardado") action QuickSave()
            textbutton _("A.Carga") action QuickLoad()
...
##aqui estuvo de nuevo
##en esta parte se configura el idioma del menu principal
screen navigation():
    ...
    vbox:
        ...
        if renpy.variant("pc"):
            ...
            textbutton _("Quitar") action Quit(confirm=not main_menu)
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("pagina {}"), auto=_("guardado automatico"), quick=_("guardado rapido"))
